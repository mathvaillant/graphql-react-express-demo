...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(clients)` | `/(projects)` | `/(tabs)` | `/_sitemap` | `/client/new` | `/constants` | `/project/new` | `/selectClient`;
  type DynamicRoutes<T extends string> = `/client/${SingleRoutePart<T>}` | `/project/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/client/[id]` | `/project/[id]`;
